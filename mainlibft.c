...
/*   Updated: 2013/11/24 16:57:36 by ccosta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
**
**
** mfontain : Je rappelle que nous sommes censés collaborer pour achever le main de test. Il n'y aura plus d'update publiques tant que nous ne seront pas au moins 6 personnes a travailler "activement" dessus.
**Venir simplement se servir ce n'est pas collaborer.

**Ceux qui ont fini et qui sont interesse peuvent nous contacter pour aider a modifier directement le main. Si d'autres personnes ont des tests plus performants que ceux du main actuel, merci de les partager avec nous.
*/
